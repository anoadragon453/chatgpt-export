!function(){var n="\n",e=document.querySelectorAll("[class*='min-h-[20px]']");for(var a=0;a<e.length;a++){var o=e[a].firstChild;if(o){if(o.nodeType===Node.ELEMENT_NODE){var l=o.childNodes;o.className.includes("request-")&&(n+=`_ChatGPT_:
